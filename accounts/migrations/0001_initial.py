    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('collection', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='accounts.collection')),
                ('promotion', models.ManyToManyField(related_name='products', to='accounts.promotion')),
            ],
        ),
        migrations.CreateModel(
            name='OrderItem',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='accounts.product'),
        ),
        migrations.CreateModel(
            name='CartItem',
            fields=[
